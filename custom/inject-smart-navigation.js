...
(function () {
  ...
  var css = ''
    ...
    + '.snav-link{background:rgba(45,212,191,.12);border:1px solid rgba(45,212,191,.35);color:#2dd4bf;'
    + 'font-family:"Vazirmatn",sans-serif;font-size:10.5px;font-weight:700;cursor:pointer;'
    + 'padding:4px 9px;border-radius:8px;transition:all .2s;-webkit-tap-highlight-color:transparent;'
    + 'display:inline-flex;align-items:center;gap:3px;}'
    + '.snav-link:hover{background:rgba(45,212,191,.22);border-color:#2dd4bf;transform:translateY(-1px);}'
